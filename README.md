...
| **Metadata 2.0**       | Workflow and Apps-MetaData can be shared with each downloaded image, share the images to allow others to recreate the same image with the same workflow and apps and its parameters! <br/> <br/> ComfyUI Metadata is untouched and remains full compatible with ComfyUI!  <br/> <br/> ⚠️ ***Install the [WorkflowUIPlugin](https://github.com/jimpi-dev/WorkflowUIPlugin)*** for best metadata support, in order to be able to reproduce a generation, the metadata will contain as much information as possible! Search for "WorkflowUIPlugin" on ComfyUI custom nodes manager! |
...
| **Queued execution**   | Queueing System! - Enqueue as much generations as you want! (*until the backend crashes ^^).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
